...
impl ScreenSize {
    ...
    pub fn mwidth(&self) -> u16 {
        unsafe { self.base.mwidth }
    }
    pub fn mheight(&self) -> u16 {
        unsafe { self.base.mheight }
    }
}
...
pub fn query_version_unchecked<'a>(
    ...
    unsafe {
        let cookie = xcb_randr_query_version_unchecked(
            c.get_raw_conn(),
...
pub fn set_screen_config<'a>(
    ...
    unsafe {
        let cookie = xcb_randr_set_screen_config(
            c.get_raw_conn(),
...
pub fn set_screen_config_unchecked<'a>(
    ...
    unsafe {
        let cookie = xcb_randr_set_screen_config_unchecked(
            c.get_raw_conn(),
            window as xcb_window_t,
            timestamp as xcb_timestamp_t,
            config_timestamp as xcb_timestamp_t,
...
impl GetScreenInfoReply {
    ...
    pub fn rates(&self) -> RefreshRatesIterator {
        unsafe { xcb_randr_get_screen_info_rates_iterator(self.ptr) }
    }
}

pub fn get_screen_info<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
...
pub fn get_screen_info_unchecked<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
) -> GetScreenInfoCookie<'a> {
    unsafe {
...
pub fn get_screen_size_range<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
...
pub fn get_screen_size_range_unchecked<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
) -> GetScreenSizeRangeCookie<'a> {
    unsafe {
...
pub fn set_screen_size<'a>(
    ...
    unsafe {
        let cookie = xcb_randr_set_screen_size(
            c.get_raw_conn(),
            window as xcb_window_t,
            width as u16,
            height as u16,
...
pub fn set_screen_size_checked<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
    width: u16,
    height: u16,
    ...
    unsafe {
        let cookie = xcb_randr_set_screen_size_checked(
            c.get_raw_conn(),
            window as xcb_window_t,
            width as u16,
            height as u16,
...
impl ModeInfo {
    ...
    pub fn dot_clock(&self) -> u32 {
        unsafe { self.base.dot_clock }
    }
    pub fn hsync_start(&self) -> u16 {
        unsafe { self.base.hsync_start }
    }
    pub fn hsync_end(&self) -> u16 {
        unsafe { self.base.hsync_end }
    }
    pub fn htotal(&self) -> u16 {
        unsafe { self.base.htotal }
    }
    pub fn hskew(&self) -> u16 {
        unsafe { self.base.hskew }
    }
    pub fn vsync_start(&self) -> u16 {
        unsafe { self.base.vsync_start }
    }
    pub fn vsync_end(&self) -> u16 {
        unsafe { self.base.vsync_end }
    }
    pub fn vtotal(&self) -> u16 {
        unsafe { self.base.vtotal }
    }
    pub fn name_len(&self) -> u16 {
        unsafe { self.base.name_len }
    }
    pub fn mode_flags(&self) -> u32 {
        unsafe { self.base.mode_flags }
    }
}
...
impl GetScreenResourcesReply {
    ...
    pub fn num_crtcs(&self) -> u16 {
        unsafe { (*self.ptr).num_crtcs }
    }
    pub fn num_outputs(&self) -> u16 {
        unsafe { (*self.ptr).num_outputs }
    }
    pub fn num_modes(&self) -> u16 {
        unsafe { (*self.ptr).num_modes }
    }
    ...
    pub fn modes(&self) -> ModeInfoIterator {
        unsafe { xcb_randr_get_screen_resources_modes_iterator(self.ptr) }
    }
...
pub fn get_screen_resources_unchecked<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
) -> GetScreenResourcesCookie<'a> {
    unsafe {
...
impl GetOutputInfoReply {
    ...
    pub fn crtc(&self) -> Crtc {
        unsafe { (*self.ptr).crtc }
    }
    pub fn mm_width(&self) -> u32 {
        unsafe { (*self.ptr).mm_width }
    }
    pub fn mm_height(&self) -> u32 {
        unsafe { (*self.ptr).mm_height }
    }
    pub fn connection(&self) -> u8 {
        unsafe { (*self.ptr).connection }
    }
    ...
    pub fn num_preferred(&self) -> u16 {
        unsafe { (*self.ptr).num_preferred }
    }
    pub fn num_clones(&self) -> u16 {
        unsafe { (*self.ptr).num_clones }
    }
    pub fn name_len(&self) -> u16 {
...
pub fn get_output_info<'a>(
    c: &'a base::Connection,
    output: Output,
    config_timestamp: xproto::Timestamp,
) -> GetOutputInfoCookie<'a> {
    unsafe {
        let cookie = xcb_randr_get_output_info(
            c.get_raw_conn(),
...
pub fn get_output_info_unchecked<'a>(
    c: &'a base::Connection,
    output: Output,
    config_timestamp: xproto::Timestamp,
) -> GetOutputInfoCookie<'a> {
    unsafe {
        let cookie = xcb_randr_get_output_info_unchecked(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            config_timestamp as xcb_timestamp_t,
        );
...
pub fn list_output_properties<'a>(
    c: &'a base::Connection,
    output: Output,
...
pub fn list_output_properties_unchecked<'a>(
    c: &'a base::Connection,
    output: Output,
) -> ListOutputPropertiesCookie<'a> {
    unsafe {
        let cookie = xcb_randr_list_output_properties_unchecked(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
        );
        ListOutputPropertiesCookie {
...
impl QueryOutputPropertyReply {
    ...
    pub fn range(&self) -> bool {
        unsafe { (*self.ptr).range != 0 }
    }
    pub fn immutable(&self) -> bool {
        unsafe { (*self.ptr).immutable != 0 }
    }
...
pub fn query_output_property<'a>(
    c: &'a base::Connection,
    output: Output,
    property: xproto::Atom,
) -> QueryOutputPropertyCookie<'a> {
    unsafe {
        let cookie = xcb_randr_query_output_property(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
...
pub fn query_output_property_unchecked<'a>(
    c: &'a base::Connection,
    output: Output,
    property: xproto::Atom,
) -> QueryOutputPropertyCookie<'a> {
    unsafe {
        let cookie = xcb_randr_query_output_property_unchecked(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            property as xcb_atom_t,
        );
...
pub fn configure_output_property<'a>(
    c: &'a base::Connection,
    output: Output,
    property: xproto::Atom,
    pending: bool,
    ...
    unsafe {
        ...
        let cookie = xcb_randr_configure_output_property(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            property as xcb_atom_t,
            pending as u8,
...
pub fn configure_output_property_checked<'a>(
    c: &'a base::Connection,
    output: Output,
    property: xproto::Atom,
    pending: bool,
    ...
    unsafe {
        let values_len = values.len();
        let values_ptr = values.as_ptr();
        let cookie = xcb_randr_configure_output_property_checked(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            property as xcb_atom_t,
            pending as u8,
...
pub fn change_output_property<'a, T>(
    c: &'a base::Connection,
    output: Output,
    property: xproto::Atom,
    type_: xproto::Atom,
    ...
    unsafe {
        ...
        let cookie = xcb_randr_change_output_property(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            property as xcb_atom_t,
            type_ as xcb_atom_t,
...
pub fn change_output_property_checked<'a, T>(
    c: &'a base::Connection,
    output: Output,
    property: xproto::Atom,
    type_: xproto::Atom,
    ...
    unsafe {
        let data_len = data.len();
        let data_ptr = data.as_ptr();
        let cookie = xcb_randr_change_output_property_checked(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            property as xcb_atom_t,
            type_ as xcb_atom_t,
...
pub fn delete_output_property<'a>(
    c: &'a base::Connection,
    output: Output,
    property: xproto::Atom,
) -> base::VoidCookie<'a> {
    unsafe {
        let cookie = xcb_randr_delete_output_property(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            property as xcb_atom_t,
        );
...
pub fn delete_output_property_checked<'a>(
    c: &'a base::Connection,
    output: Output,
    property: xproto::Atom,
) -> base::VoidCookie<'a> {
    unsafe {
        let cookie = xcb_randr_delete_output_property_checked(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            property as xcb_atom_t,
        );
...
pub fn get_output_property<'a>(
    ...
    unsafe {
        let cookie = xcb_randr_get_output_property(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            property as xcb_atom_t,
            type_ as xcb_atom_t,
...
pub fn get_output_property_unchecked<'a>(
    ...
    unsafe {
        let cookie = xcb_randr_get_output_property_unchecked(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            property as xcb_atom_t,
            type_ as xcb_atom_t,
...
pub fn create_mode<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_randr_create_mode(
            c.get_raw_conn(),
            window as xcb_window_t,
            mode_info.base,
            name_len as u32,
...
pub fn create_mode_unchecked<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
    mode_info: ModeInfo,
    name: &str,
    ...
    unsafe {
        ...
        let name_len = name.len();
        let name_ptr = name.as_ptr();
        let cookie = xcb_randr_create_mode_unchecked(
            c.get_raw_conn(),
            window as xcb_window_t,
            mode_info.base,
            name_len as u32,
...
pub fn add_output_mode<'a>(
    c: &'a base::Connection,
    output: Output,
    mode: Mode,
) -> base::VoidCookie<'a> {
    unsafe {
        let cookie = xcb_randr_add_output_mode(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
...
pub fn add_output_mode_checked<'a>(
    c: &'a base::Connection,
    output: Output,
    mode: Mode,
) -> base::VoidCookie<'a> {
    unsafe {
        let cookie = xcb_randr_add_output_mode_checked(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            mode as xcb_randr_mode_t,
        );
...
pub fn delete_output_mode<'a>(
    c: &'a base::Connection,
    output: Output,
    mode: Mode,
) -> base::VoidCookie<'a> {
    unsafe {
        let cookie = xcb_randr_delete_output_mode(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            mode as xcb_randr_mode_t,
        );
...
pub fn delete_output_mode_checked<'a>(
    c: &'a base::Connection,
    output: Output,
    mode: Mode,
) -> base::VoidCookie<'a> {
    unsafe {
        let cookie = xcb_randr_delete_output_mode_checked(
            c.get_raw_conn(),
            output as xcb_randr_output_t,
            mode as xcb_randr_mode_t,
        );
...
impl GetCrtcInfoReply {
    ...
    pub fn num_possible_outputs(&self) -> u16 {
        unsafe { (*self.ptr).num_possible_outputs }
    }
    pub fn outputs(&self) -> &[Output] {
        unsafe {
            let field = self.ptr;
...
pub fn get_crtc_info<'a>(
    c: &'a base::Connection,
    crtc: Crtc,
    config_timestamp: xproto::Timestamp,
) -> GetCrtcInfoCookie<'a> {
    unsafe {
        let cookie = xcb_randr_get_crtc_info(
            c.get_raw_conn(),
...
pub fn get_crtc_info_unchecked<'a>(
    c: &'a base::Connection,
    crtc: Crtc,
    config_timestamp: xproto::Timestamp,
) -> GetCrtcInfoCookie<'a> {
    unsafe {
        let cookie = xcb_randr_get_crtc_info_unchecked(
            c.get_raw_conn(),
            crtc as xcb_randr_crtc_t,
            config_timestamp as xcb_timestamp_t,
        );
...
pub fn set_crtc_config<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_randr_set_crtc_config(
            c.get_raw_conn(),
            crtc as xcb_randr_crtc_t,
            timestamp as xcb_timestamp_t,
            config_timestamp as xcb_timestamp_t,
            ...
            rotation as u16,
            outputs_len as u32,
            outputs_ptr as *const xcb_randr_output_t,
        );
        SetCrtcConfigCookie {
            cookie: cookie,
            conn: c,
...
pub fn set_crtc_config_unchecked<'a>(
    c: &'a base::Connection,
    crtc: Crtc,
    timestamp: xproto::Timestamp,
    config_timestamp: xproto::Timestamp,
    ...
    unsafe {
        let outputs_len = outputs.len();
        let outputs_ptr = outputs.as_ptr();
        let cookie = xcb_randr_set_crtc_config_unchecked(
            c.get_raw_conn(),
            crtc as xcb_randr_crtc_t,
            timestamp as xcb_timestamp_t,
            config_timestamp as xcb_timestamp_t,
...
pub fn get_crtc_gamma_size_unchecked<'a>(
    c: &'a base::Connection,
    crtc: Crtc,
...
pub fn set_crtc_gamma<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_randr_set_crtc_gamma(
            c.get_raw_conn(),
            crtc as xcb_randr_crtc_t,
            red_len as u16,
            red_ptr as *const u16,
            green_ptr as *const u16,
            blue_ptr as *const u16,
        );
        base::VoidCookie {
            cookie: cookie,
            conn: c,
...
pub fn set_crtc_gamma_checked<'a>(
    c: &'a base::Connection,
    crtc: Crtc,
    red: &[u16],
    green: &[u16],
    ...
    unsafe {
        ...
        let green_ptr = green.as_ptr();
        let blue_ptr = blue.as_ptr();
        let cookie = xcb_randr_set_crtc_gamma_checked(
            c.get_raw_conn(),
            crtc as xcb_randr_crtc_t,
            red_len as u16,
            red_ptr as *const u16,
...
impl GetScreenResourcesCurrentReply {
    ...
    pub fn modes(&self) -> ModeInfoIterator {
        unsafe { xcb_randr_get_screen_resources_current_modes_iterator(self.ptr) }
    }
    pub fn names(&self) -> &[u8] {
        unsafe {
            let field = self.ptr;
...
pub fn get_screen_resources_current<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
...
pub fn get_screen_resources_current_unchecked<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
) -> GetScreenResourcesCurrentCookie<'a> {
    unsafe {
        let cookie = xcb_randr_get_screen_resources_current_unchecked(
            c.get_raw_conn(),
            window as xcb_window_t,
        );
        GetScreenResourcesCurrentCookie {
...
pub fn set_crtc_transform<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_randr_set_crtc_transform(
            c.get_raw_conn(),
            crtc as xcb_randr_crtc_t,
            transform.base,
            filter_name_len as u16,
            filter_name_ptr as *const c_char,
            filter_params_len as u32,
            filter_params_ptr as *const xcb_render_fixed_t,
        );
        base::VoidCookie {
            cookie: cookie,
            conn: c,
...
pub fn set_crtc_transform_checked<'a>(
    ...
    unsafe {
        ...
        let filter_params_len = filter_params.len();
        let filter_params_ptr = filter_params.as_ptr();
        let cookie = xcb_randr_set_crtc_transform_checked(
            c.get_raw_conn(),
            crtc as xcb_randr_crtc_t,
            transform.base,
            filter_name_len as u16,
...
impl GetCrtcTransformReply {
    pub fn pending_transform(&self) -> render::Transform {
        unsafe { std::mem::transmute((*self.ptr).pending_transform) }
    }
    pub fn has_transforms(&self) -> bool {
        unsafe { (*self.ptr).has_transforms != 0 }
    }
    pub fn current_transform(&self) -> render::Transform {
        unsafe { std::mem::transmute((*self.ptr).current_transform) }
    }
    pub fn pending_len(&self) -> u16 {
        unsafe { (*self.ptr).pending_len }
    }
    pub fn pending_nparams(&self) -> u16 {
        unsafe { (*self.ptr).pending_nparams }
    }
    pub fn current_len(&self) -> u16 {
        unsafe { (*self.ptr).current_len }
    }
    pub fn current_nparams(&self) -> u16 {
        unsafe { (*self.ptr).current_nparams }
    }
...
pub fn get_crtc_transform_unchecked<'a>(
    c: &'a base::Connection,
    crtc: Crtc,
...
impl GetPanningReply {
    ...
    pub fn track_left(&self) -> u16 {
        unsafe { (*self.ptr).track_left }
    }
    pub fn track_top(&self) -> u16 {
        unsafe { (*self.ptr).track_top }
    }
    pub fn track_width(&self) -> u16 {
        unsafe { (*self.ptr).track_width }
    }
    pub fn track_height(&self) -> u16 {
        unsafe { (*self.ptr).track_height }
    }
    pub fn border_left(&self) -> i16 {
        unsafe { (*self.ptr).border_left }
    }
    pub fn border_top(&self) -> i16 {
        unsafe { (*self.ptr).border_top }
    }
    pub fn border_right(&self) -> i16 {
        unsafe { (*self.ptr).border_right }
    }
    pub fn border_bottom(&self) -> i16 {
        unsafe { (*self.ptr).border_bottom }
    }
}
...
pub fn set_panning<'a>(
    ...
    unsafe {
        let cookie = xcb_randr_set_panning(
            c.get_raw_conn(),
            crtc as xcb_randr_crtc_t,
            timestamp as xcb_timestamp_t,
            left as u16,
...
pub fn set_panning_unchecked<'a>(
    c: &'a base::Connection,
    crtc: Crtc,
    timestamp: xproto::Timestamp,
    left: u16,
    ...
    unsafe {
        let cookie = xcb_randr_set_panning_unchecked(
            c.get_raw_conn(),
            crtc as xcb_randr_crtc_t,
            timestamp as xcb_timestamp_t,
            left as u16,
...
pub fn set_output_primary<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
    output: Output,
) -> base::VoidCookie<'a> {
    unsafe {
        let cookie = xcb_randr_set_output_primary(
            c.get_raw_conn(),
            window as xcb_window_t,
            output as xcb_randr_output_t,
        );
...
pub fn set_output_primary_checked<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
    output: Output,
) -> base::VoidCookie<'a> {
    unsafe {
        let cookie = xcb_randr_set_output_primary_checked(
            c.get_raw_conn(),
            window as xcb_window_t,
            output as xcb_randr_output_t,
        );
...
pub fn get_output_primary_unchecked<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
) -> GetOutputPrimaryCookie<'a> {
    unsafe {
...
pub fn get_providers_unchecked<'a>(
    c: &'a base::Connection,
    window: xproto::Window,
) -> GetProvidersCookie<'a> {
    unsafe {
...
impl GetProviderInfoReply {
    ...
    pub fn num_associated_providers(&self) -> u16 {
        unsafe { (*self.ptr).num_associated_providers }
    }
    pub fn name_len(&self) -> u16 {
        unsafe { (*self.ptr).name_len }
    }
...
pub fn get_provider_info<'a>(
    c: &'a base::Connection,
    provider: Provider,
    config_timestamp: xproto::Timestamp,
) -> GetProviderInfoCookie<'a> {
    unsafe {
        let cookie = xcb_randr_get_provider_info(
            c.get_raw_conn(),
...
pub fn get_provider_info_unchecked<'a>(
    c: &'a base::Connection,
    provider: Provider,
    config_timestamp: xproto::Timestamp,
) -> GetProviderInfoCookie<'a> {
    unsafe {
        let cookie = xcb_randr_get_provider_info_unchecked(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            config_timestamp as xcb_timestamp_t,
        );
...
pub fn set_provider_offload_sink<'a>(
    c: &'a base::Connection,
    provider: Provider,
    ...
    unsafe {
        let cookie = xcb_randr_set_provider_offload_sink(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
...
pub fn set_provider_offload_sink_checked<'a>(
    c: &'a base::Connection,
    provider: Provider,
    sink_provider: Provider,
    config_timestamp: xproto::Timestamp,
    ...
    unsafe {
        let cookie = xcb_randr_set_provider_offload_sink_checked(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            sink_provider as xcb_randr_provider_t,
            config_timestamp as xcb_timestamp_t,
...
pub fn set_provider_output_source<'a>(
    c: &'a base::Connection,
    provider: Provider,
    ...
    unsafe {
        let cookie = xcb_randr_set_provider_output_source(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
...
pub fn set_provider_output_source_checked<'a>(
    c: &'a base::Connection,
    provider: Provider,
    source_provider: Provider,
    config_timestamp: xproto::Timestamp,
    ...
    unsafe {
        let cookie = xcb_randr_set_provider_output_source_checked(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            source_provider as xcb_randr_provider_t,
            config_timestamp as xcb_timestamp_t,
...
pub fn list_provider_properties<'a>(
    c: &'a base::Connection,
    provider: Provider,
...
pub fn list_provider_properties_unchecked<'a>(
    c: &'a base::Connection,
    provider: Provider,
) -> ListProviderPropertiesCookie<'a> {
    unsafe {
        let cookie = xcb_randr_list_provider_properties_unchecked(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
        );
        ListProviderPropertiesCookie {
...
pub fn query_provider_property<'a>(
    c: &'a base::Connection,
    provider: Provider,
    property: xproto::Atom,
) -> QueryProviderPropertyCookie<'a> {
    unsafe {
        let cookie = xcb_randr_query_provider_property(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            property as xcb_atom_t,
        );
...
pub fn query_provider_property_unchecked<'a>(
    c: &'a base::Connection,
    provider: Provider,
    property: xproto::Atom,
) -> QueryProviderPropertyCookie<'a> {
    unsafe {
        let cookie = xcb_randr_query_provider_property_unchecked(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            property as xcb_atom_t,
        );
...
pub fn configure_provider_property<'a>(
    c: &'a base::Connection,
    provider: Provider,
    property: xproto::Atom,
    pending: bool,
    ...
    unsafe {
        let values_len = values.len();
        let values_ptr = values.as_ptr();
        let cookie = xcb_randr_configure_provider_property(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            property as xcb_atom_t,
            pending as u8,
...
pub fn configure_provider_property_checked<'a>(
    c: &'a base::Connection,
    provider: Provider,
    property: xproto::Atom,
    pending: bool,
    ...
    unsafe {
        let values_len = values.len();
        let values_ptr = values.as_ptr();
        let cookie = xcb_randr_configure_provider_property_checked(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            property as xcb_atom_t,
            pending as u8,
...
pub fn change_provider_property<'a, T>(
    c: &'a base::Connection,
    provider: Provider,
    property: xproto::Atom,
    type_: xproto::Atom,
    ...
    unsafe {
        let data_len = data.len();
        let data_ptr = data.as_ptr();
        let cookie = xcb_randr_change_provider_property(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            property as xcb_atom_t,
            type_ as xcb_atom_t,
...
pub fn change_provider_property_checked<'a, T>(
    c: &'a base::Connection,
    provider: Provider,
    property: xproto::Atom,
    type_: xproto::Atom,
    ...
    unsafe {
        let data_len = data.len();
        let data_ptr = data.as_ptr();
        let cookie = xcb_randr_change_provider_property_checked(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            property as xcb_atom_t,
            type_ as xcb_atom_t,
...
pub fn delete_provider_property<'a>(
    c: &'a base::Connection,
    provider: Provider,
    property: xproto::Atom,
) -> base::VoidCookie<'a> {
    unsafe {
        let cookie = xcb_randr_delete_provider_property(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            property as xcb_atom_t,
        );
...
pub fn delete_provider_property_checked<'a>(
    c: &'a base::Connection,
    provider: Provider,
    property: xproto::Atom,
) -> base::VoidCookie<'a> {
    unsafe {
        let cookie = xcb_randr_delete_provider_property_checked(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            property as xcb_atom_t,
        );
...
pub fn get_provider_property<'a>(
    c: &'a base::Connection,
    provider: Provider,
    property: xproto::Atom,
    type_: xproto::Atom,
    ...
    unsafe {
        let cookie = xcb_randr_get_provider_property(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            property as xcb_atom_t,
            type_ as xcb_atom_t,
...
pub fn get_provider_property_unchecked<'a>(
    c: &'a base::Connection,
    provider: Provider,
    property: xproto::Atom,
    type_: xproto::Atom,
    ...
    unsafe {
        let cookie = xcb_randr_get_provider_property_unchecked(
            c.get_raw_conn(),
            provider as xcb_randr_provider_t,
            property as xcb_atom_t,
            type_ as xcb_atom_t,
...
impl ScreenChangeNotifyEvent {
    ...
    pub fn mwidth(&self) -> u16 {
        unsafe { (*self.ptr).mwidth }
    }
    pub fn mheight(&self) -> u16 {
        unsafe { (*self.ptr).mheight }
    }
    ...
    pub fn new(
        ...
        unsafe {
            ...
            (*raw).mwidth = mwidth;
            (*raw).mheight = mheight;
            ScreenChangeNotifyEvent { ptr: raw }
        }
    }
}
...
impl CrtcChange {
    ...
    pub fn timestamp(&self) -> xproto::Timestamp {
        unsafe { self.base.timestamp }
    }
    pub fn window(&self) -> xproto::Window {
        unsafe { self.base.window }
    }
    pub fn crtc(&self) -> Crtc {
        unsafe { self.base.crtc }
    }
    pub fn mode(&self) -> Mode {
        unsafe { self.base.mode }
    }
    pub fn rotation(&self) -> u16 {
        unsafe { self.base.rotation }
    }
    pub fn x(&self) -> i16 {
        unsafe { self.base.x }
    }
...
impl OutputChange {
    ...
    pub fn config_timestamp(&self) -> xproto::Timestamp {
        unsafe { self.base.config_timestamp }
    }
    pub fn window(&self) -> xproto::Window {
        unsafe { self.base.window }
    }
    pub fn output(&self) -> Output {
        unsafe { self.base.output }
    }
    pub fn crtc(&self) -> Crtc {
        unsafe { self.base.crtc }
    }
    ...
    pub fn connection(&self) -> u8 {
        unsafe { self.base.connection }
    }
    pub fn subpixel_order(&self) -> u8 {
        unsafe { self.base.subpixel_order }
    }
}
...
impl OutputProperty {
    ...
    pub fn atom(&self) -> xproto::Atom {
        unsafe { self.base.atom }
    }
    pub fn timestamp(&self) -> xproto::Timestamp {
        unsafe { self.base.timestamp }
    }
    pub fn status(&self) -> u8 {
        unsafe { self.base.status }
    }
}
