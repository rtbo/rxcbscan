...
impl QueryVersionReply {
    pub fn dri_major_version(&self) -> u16 {
        unsafe { (*self.ptr).dri_major_version }
    }
    pub fn dri_minor_version(&self) -> u16 {
        unsafe { (*self.ptr).dri_minor_version }
    }
    pub fn dri_minor_patch(&self) -> u32 {
        unsafe { (*self.ptr).dri_minor_patch }
    }
}
...
impl QueryDirectRenderingCapableReply {
    pub fn is_capable(&self) -> bool {
        unsafe { (*self.ptr).is_capable != 0 }
    }
}

pub fn query_direct_rendering_capable<'a>(
    c: &'a base::Connection,
    screen: u32,
...
pub fn query_direct_rendering_capable_unchecked<'a>(
    c: &'a base::Connection,
    screen: u32,
) -> QueryDirectRenderingCapableCookie<'a> {
    unsafe {
...
impl OpenConnectionReply {
    pub fn sarea_handle_low(&self) -> u32 {
        unsafe { (*self.ptr).sarea_handle_low }
    }
    pub fn sarea_handle_high(&self) -> u32 {
        unsafe { (*self.ptr).sarea_handle_high }
    }
    pub fn bus_id_len(&self) -> u32 {
        unsafe { (*self.ptr).bus_id_len }
    }
...
pub fn open_connection_unchecked<'a>(
    c: &'a base::Connection,
    screen: u32,
) -> OpenConnectionCookie<'a> {
    unsafe {
...
impl GetClientDriverNameReply {
    pub fn client_driver_major_version(&self) -> u32 {
        unsafe { (*self.ptr).client_driver_major_version }
    }
    pub fn client_driver_minor_version(&self) -> u32 {
        unsafe { (*self.ptr).client_driver_minor_version }
    }
    pub fn client_driver_patch_version(&self) -> u32 {
        unsafe { (*self.ptr).client_driver_patch_version }
    }
    pub fn client_driver_name_len(&self) -> u32 {
        unsafe { (*self.ptr).client_driver_name_len }
    }
...
pub fn get_client_driver_name<'a>(
    c: &'a base::Connection,
    screen: u32,
...
pub fn get_client_driver_name_unchecked<'a>(
    c: &'a base::Connection,
    screen: u32,
) -> GetClientDriverNameCookie<'a> {
    unsafe {
...
pub fn create_context<'a>(
    ...
    unsafe {
        let cookie = xcb_xf86dri_create_context(
            c.get_raw_conn(),
            screen as u32,
            visual as u32,
            context as u32,
...
pub fn create_context_unchecked<'a>(
    ...
    unsafe {
        let cookie = xcb_xf86dri_create_context_unchecked(
            c.get_raw_conn(),
            screen as u32,
            visual as u32,
            context as u32,
...
impl CreateDrawableReply {
    pub fn hw_drawable_handle(&self) -> u32 {
        unsafe { (*self.ptr).hw_drawable_handle }
    }
}
...
pub fn create_drawable_unchecked<'a>(
    c: &'a base::Connection,
    screen: u32,
    drawable: u32,
) -> CreateDrawableCookie<'a> {
...
impl GetDrawableInfoReply {
    pub fn drawable_table_index(&self) -> u32 {
        unsafe { (*self.ptr).drawable_table_index }
    }
    pub fn drawable_table_stamp(&self) -> u32 {
        unsafe { (*self.ptr).drawable_table_stamp }
    }
    pub fn drawable_origin__x(&self) -> i16 {
        unsafe { (*self.ptr).drawable_origin_X }
    }
    pub fn drawable_origin__y(&self) -> i16 {
        unsafe { (*self.ptr).drawable_origin_Y }
    }
    pub fn drawable_size__w(&self) -> i16 {
        unsafe { (*self.ptr).drawable_size_W }
    }
    pub fn drawable_size__h(&self) -> i16 {
        unsafe { (*self.ptr).drawable_size_H }
    }
    pub fn num_clip_rects(&self) -> u32 {
        unsafe { (*self.ptr).num_clip_rects }
    }
    pub fn back_x(&self) -> i16 {
        unsafe { (*self.ptr).back_x }
    }
    pub fn back_y(&self) -> i16 {
        unsafe { (*self.ptr).back_y }
    }
    pub fn num_back_clip_rects(&self) -> u32 {
        unsafe { (*self.ptr).num_back_clip_rects }
    }
    pub fn clip_rects(&self) -> DrmClipRectIterator {
        unsafe { xcb_xf86dri_get_drawable_info_clip_rects_iterator(self.ptr) }
    }
    pub fn back_clip_rects(&self) -> DrmClipRectIterator {
        unsafe { xcb_xf86dri_get_drawable_info_back_clip_rects_iterator(self.ptr) }
    }
}

pub fn get_drawable_info<'a>(
    c: &'a base::Connection,
    screen: u32,
    drawable: u32,
...
pub fn get_drawable_info_unchecked<'a>(
    c: &'a base::Connection,
    screen: u32,
    drawable: u32,
) -> GetDrawableInfoCookie<'a> {
    unsafe {
        let cookie = xcb_xf86dri_get_drawable_info_unchecked(
            c.get_raw_conn(),
            screen as u32,
            drawable as u32,
        );
...
impl GetDeviceInfoReply {
    pub fn framebuffer_handle_low(&self) -> u32 {
        unsafe { (*self.ptr).framebuffer_handle_low }
    }
    pub fn framebuffer_handle_high(&self) -> u32 {
        unsafe { (*self.ptr).framebuffer_handle_high }
    }
    pub fn framebuffer_origin_offset(&self) -> u32 {
        unsafe { (*self.ptr).framebuffer_origin_offset }
    }
    pub fn framebuffer_size(&self) -> u32 {
        unsafe { (*self.ptr).framebuffer_size }
    }
    pub fn framebuffer_stride(&self) -> u32 {
        unsafe { (*self.ptr).framebuffer_stride }
    }
    pub fn device_private_size(&self) -> u32 {
        unsafe { (*self.ptr).device_private_size }
    }
...
pub fn auth_connection_unchecked<'a>(
    c: &'a base::Connection,
    screen: u32,
    magic: u32,
) -> AuthConnectionCookie<'a> {
