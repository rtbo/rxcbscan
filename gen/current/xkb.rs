...
impl<'a> KeyAlias<'a> {
    pub fn real(&self) -> &[c_char] {
        unsafe { &(*self.ptr).real }
    }
    pub fn alias(&self) -> &[c_char] {
        unsafe { &(*self.ptr).alias }
    }
}
...
impl KtMapEntry {
    ...
    pub fn active(&self) -> bool {
        unsafe { self.base.active != 0 }
    }
    pub fn mods_mask(&self) -> u8 {
        unsafe { self.base.mods_mask }
    }
    pub fn level(&self) -> u8 {
        unsafe { self.base.level }
    }
    pub fn mods_mods(&self) -> u8 {
        unsafe { self.base.mods_mods }
    }
    pub fn mods_vmods(&self) -> u16 {
        unsafe { self.base.mods_vmods }
    }
}
...
impl<'a> KeyType<'a> {
    pub fn mods_mask(&self) -> u8 {
        unsafe { (*self.ptr).mods_mask }
    }
    pub fn mods_mods(&self) -> u8 {
        unsafe { (*self.ptr).mods_mods }
    }
    pub fn mods_vmods(&self) -> u16 {
    ...
    pub fn preserve(&self) -> ModDefIterator {
        unsafe { xcb_xkb_key_type_preserve_iterator(self.ptr) }
    }
}
...
impl SetExplicit {
    ...
    pub fn keycode(&self) -> xproto::Keycode {
        unsafe { self.base.keycode }
    }
    pub fn explicit(&self) -> u8 {
        unsafe { self.base.explicit }
    }
}
...
impl<'a> SetKeyType<'a> {
    ...
    pub fn entries(&self) -> KtSetMapEntryIterator {
        unsafe { xcb_xkb_set_key_type_entries_iterator(self.ptr) }
    }
    pub fn preserve_entries(&self) -> KtSetMapEntryIterator {
        unsafe { xcb_xkb_set_key_type_preserve_entries_iterator(self.ptr) }
    }
}
...
impl<'a> OverlayKey<'a> {
    pub fn over(&self) -> &[String8] {
        unsafe { &(*self.ptr).over }
    }
    pub fn under(&self) -> &[String8] {
        unsafe { &(*self.ptr).under }
    }
}
...
impl<'a> Row<'a> {
    ...
    pub fn keys(&self) -> KeyIterator<'a> {
        unsafe { xcb_xkb_row_keys_iterator(self.ptr) }
    }
}
...
impl<'a> DeviceLedInfo<'a> {
    ...
    pub fn maps(&self) -> IndicatorMapIterator {
        unsafe { xcb_xkb_device_led_info_maps_iterator(self.ptr) }
    }
}
...
impl SaDeviceValuator {
    ...
    pub fn val1what(&self) -> u8 {
        unsafe { self.base.val1what }
    }
    pub fn val1index(&self) -> u8 {
        unsafe { self.base.val1index }
    }
    pub fn val1value(&self) -> u8 {
        unsafe { self.base.val1value }
    }
    pub fn val2what(&self) -> u8 {
        unsafe { self.base.val2what }
    }
    pub fn val2index(&self) -> u8 {
        unsafe { self.base.val2index }
    }
    pub fn val2value(&self) -> u8 {
        unsafe { self.base.val2value }
    }
}
...
impl<'a> SymInterpret<'a> {
    ...
    pub fn action(&self) -> SiAction {
        unsafe { std::mem::transmute(&(*self.ptr).action) }
    }
}
...
pub fn use_extension_unchecked<'a>(
    c: &'a base::Connection,
    wanted_major: u16,
    wanted_minor: u16,
) -> UseExtensionCookie<'a> {
    unsafe {
        let cookie = xcb_xkb_use_extension_unchecked(
            c.get_raw_conn(),
            wanted_major as u16,
            wanted_minor as u16,
        );
...
pub fn select_events<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_xkb_select_events(
            c.get_raw_conn(),
...
pub fn select_events_checked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    affect_which: u16,
    clear: u16,
...
pub fn bell_checked<'a>(
    ...
    unsafe {
        let cookie = xcb_xkb_bell_checked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            bell_class as xcb_xkb_bell_class_spec_t,
            bell_id as xcb_xkb_id_spec_t,
...
pub fn latch_lock_state<'a>(
    ...
    unsafe {
        let cookie = xcb_xkb_latch_lock_state(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            affect_mod_locks as u8,
            mod_locks as u8,
            lock_group as u8,
            group_lock as u8,
            affect_mod_latches as u8,
            latch_group as u8,
            group_latch as u16,
        );
        base::VoidCookie {
...
pub fn latch_lock_state_checked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    affect_mod_locks: u8,
    mod_locks: u8,
    ...
    unsafe {
        let cookie = xcb_xkb_latch_lock_state_checked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            affect_mod_locks as u8,
            mod_locks as u8,
...
pub fn get_controls_unchecked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
) -> GetControlsCookie<'a> {
    unsafe {
...
pub fn set_controls<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_xkb_set_controls(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            affect_internal_real_mods as u8,
            internal_real_mods as u8,
            affect_ignore_lock_real_mods as u8,
            ignore_lock_real_mods as u8,
            affect_internal_virtual_mods as u16,
            internal_virtual_mods as u16,
            affect_ignore_lock_virtual_mods as u16,
            ignore_lock_virtual_mods as u16,
            mouse_keys_dflt_btn as u8,
            groups_wrap as u8,
            access_x_options as u16,
            affect_enabled_controls as u32,
            enabled_controls as u32,
            change_controls as u32,
            repeat_delay as u16,
            repeat_interval as u16,
            slow_keys_delay as u16,
            debounce_delay as u16,
            mouse_keys_delay as u16,
            mouse_keys_interval as u16,
            mouse_keys_time_to_max as u16,
            mouse_keys_max_speed as u16,
            mouse_keys_curve as i16,
            access_x_timeout as u16,
            access_x_timeout_mask as u32,
            access_x_timeout_values as u32,
            access_x_timeout_options_mask as u16,
            access_x_timeout_options_values as u16,
            per_key_repeat_ptr as *const u8,
        );
        base::VoidCookie {
            cookie: cookie,
            conn: c,
...
pub fn set_controls_checked<'a>(
    ...
    unsafe {
        let per_key_repeat_ptr = per_key_repeat.as_ptr();
        let cookie = xcb_xkb_set_controls_checked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            affect_internal_real_mods as u8,
            internal_real_mods as u8,
...
pub fn get_map<'a>(
    ...
    unsafe {
        let cookie = xcb_xkb_get_map(
            ...
            first_type as u8,
            n_types as u8,
            first_key_sym as xcb_keycode_t,
            n_key_syms as u8,
            first_key_action as xcb_keycode_t,
            n_key_actions as u8,
            first_key_behavior as xcb_keycode_t,
            n_key_behaviors as u8,
            virtual_mods as u16,
            first_key_explicit as xcb_keycode_t,
            n_key_explicit as u8,
            first_mod_map_key as xcb_keycode_t,
            n_mod_map_keys as u8,
            first_v_mod_map_key as xcb_keycode_t,
            n_v_mod_map_keys as u8,
        );
        GetMapCookie {
            cookie: cookie,
            conn: c,
...
pub fn get_map_unchecked<'a>(
    ...
    unsafe {
        let cookie = xcb_xkb_get_map_unchecked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            full as u16,
            partial as u16,
...
pub fn set_map<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_xkb_set_map(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            present as u16,
            flags as u16,
            min_key_code as xcb_keycode_t,
            max_key_code as xcb_keycode_t,
            first_type as u8,
            n_types as u8,
            first_key_sym as xcb_keycode_t,
            n_key_syms as u8,
            ...
            first_key_action as xcb_keycode_t,
            n_key_actions as u8,
            total_actions as u16,
            first_key_behavior as xcb_keycode_t,
            n_key_behaviors as u8,
            total_key_behaviors as u8,
            first_key_explicit as xcb_keycode_t,
            n_key_explicit as u8,
            total_key_explicit as u8,
            first_mod_map_key as xcb_keycode_t,
            n_mod_map_keys as u8,
            total_mod_map_keys as u8,
            first_v_mod_map_key as xcb_keycode_t,
            n_v_mod_map_keys as u8,
            total_v_mod_map_keys as u8,
            virtual_mods as u16,
            values_ptr,
        );
        base::VoidCookie {
...
pub fn set_map_checked<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_xkb_set_map_checked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            present as u16,
            flags as u16,
...
impl GetCompatMapReply {
    ...
    pub fn group_rtrn(&self) -> ModDefIterator {
        unsafe { xcb_xkb_get_compat_map_group_rtrn_iterator(self.ptr) }
    }
}
...
pub fn set_compat_map<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_xkb_set_compat_map(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
...
pub fn set_compat_map_checked<'a>(
    ...
    unsafe {
        ...
        let group_maps_len = group_maps.len();
        let group_maps_ptr = group_maps.as_ptr();
        let cookie = xcb_xkb_set_compat_map_checked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            recompute_actions as u8,
            truncate_si as u8,
...
pub fn get_indicator_state_unchecked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
) -> GetIndicatorStateCookie<'a> {
    unsafe {
        let cookie = xcb_xkb_get_indicator_state_unchecked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
        );
        GetIndicatorStateCookie {
...
pub fn get_indicator_map<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    which: u32,
) -> GetIndicatorMapCookie<'a> {
    unsafe {
        let cookie = xcb_xkb_get_indicator_map(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            which as u32,
        );
...
pub fn get_indicator_map_unchecked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    which: u32,
) -> GetIndicatorMapCookie<'a> {
    unsafe {
        let cookie = xcb_xkb_get_indicator_map_unchecked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            which as u32,
        );
...
pub fn set_indicator_map<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_xkb_set_indicator_map(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            maps_len as u32,
            maps_ptr as *const xcb_xkb_indicator_map_t,
        );
        base::VoidCookie {
            cookie: cookie,
            conn: c,
...
pub fn set_indicator_map_checked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    maps: &[IndicatorMap],
) -> base::VoidCookie<'a> {
    unsafe {
        let maps_len = maps.len();
        let maps_ptr = maps.as_ptr();
        let cookie = xcb_xkb_set_indicator_map_checked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            maps_len as u32,
            maps_ptr as *const xcb_xkb_indicator_map_t,
...
pub fn get_named_indicator<'a>(
    ...
    unsafe {
        let cookie = xcb_xkb_get_named_indicator(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
...
pub fn get_named_indicator_unchecked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    led_class: LedClassSpec,
    led_id: IdSpec,
    ...
    unsafe {
        let cookie = xcb_xkb_get_named_indicator_unchecked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            led_class as xcb_xkb_led_class_spec_t,
            led_id as xcb_xkb_id_spec_t,
...
pub fn set_named_indicator<'a>(
    ...
    unsafe {
        let cookie = xcb_xkb_set_named_indicator(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            led_class as xcb_xkb_led_class_spec_t,
            led_id as xcb_xkb_id_spec_t,
            ...
            create_map as u8,
            map_flags as u8,
            map_which_groups as u8,
            map_groups as u8,
            map_which_mods as u8,
            map_real_mods as u8,
            map_vmods as u16,
            map_ctrls as u32,
        );
...
pub fn set_named_indicator_checked<'a>(
    ...
    unsafe {
        let cookie = xcb_xkb_set_named_indicator_checked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            led_class as xcb_xkb_led_class_spec_t,
            led_id as xcb_xkb_id_spec_t,
...
pub fn get_names_unchecked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    which: u32,
) -> GetNamesCookie<'a> {
    unsafe {
        let cookie = xcb_xkb_get_names_unchecked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            which as u32,
        );
...
pub fn set_names_checked<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_xkb_set_names_checked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            virtual_mods as u16,
            which as u32,
...
pub fn per_client_flags<'a>(
    ...
    unsafe {
        let cookie = xcb_xkb_per_client_flags(
            ...
            change as u32,
            value as u32,
            ctrls_to_change as u32,
            auto_ctrls as u32,
            auto_ctrls_values as u32,
        );
...
pub fn per_client_flags_unchecked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    change: u32,
    value: u32,
    ...
    unsafe {
        let cookie = xcb_xkb_per_client_flags_unchecked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            change as u32,
            value as u32,
...
impl ListComponentsReply {
    ...
    pub fn keymaps(&self) -> ListingIterator {
        unsafe { xcb_xkb_list_components_keymaps_iterator(self.ptr) }
    }
    pub fn keycodes(&self) -> ListingIterator {
        unsafe { xcb_xkb_list_components_keycodes_iterator(self.ptr) }
    }
    pub fn types(&self) -> ListingIterator {
        unsafe { xcb_xkb_list_components_types_iterator(self.ptr) }
    }
    pub fn compat_maps(&self) -> ListingIterator {
        unsafe { xcb_xkb_list_components_compat_maps_iterator(self.ptr) }
    }
    pub fn symbols(&self) -> ListingIterator {
        unsafe { xcb_xkb_list_components_symbols_iterator(self.ptr) }
    }
    pub fn geometries(&self) -> ListingIterator {
        unsafe { xcb_xkb_list_components_geometries_iterator(self.ptr) }
    }
}

pub fn list_components<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    max_names: u16,
) -> ListComponentsCookie<'a> {
    unsafe {
        let cookie = xcb_xkb_list_components(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            max_names as u16,
        );
...
pub fn list_components_unchecked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    max_names: u16,
) -> ListComponentsCookie<'a> {
    unsafe {
        let cookie = xcb_xkb_list_components_unchecked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            max_names as u16,
        );
...
impl GetKbdByNameReply {
    ...
    pub fn reported(&self) -> u16 {
        unsafe { (*self.ptr).reported }
    }
}

pub fn get_kbd_by_name<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    need: u16,
    want: u16,
    ...
    unsafe {
        let cookie = xcb_xkb_get_kbd_by_name(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            need as u16,
            want as u16,
...
pub fn get_kbd_by_name_unchecked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    need: u16,
    want: u16,
    ...
    unsafe {
        let cookie = xcb_xkb_get_kbd_by_name_unchecked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            need as u16,
            want as u16,
...
impl GetDeviceInfoReply {
    ...
    pub fn btn_actions(&self) -> ActionIterator {
        unsafe { xcb_xkb_get_device_info_btn_actions_iterator(self.ptr) }
    }
    pub fn leds(&self) -> DeviceLedInfoIterator {
        unsafe { xcb_xkb_get_device_info_leds_iterator(self.ptr) }
    }
}
...
pub fn get_device_info_unchecked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    wanted: u16,
    all_buttons: bool,
...
pub fn set_device_info<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_xkb_set_device_info(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            first_btn as u8,
            btn_actions_len as u8,
            change as u16,
            leds_len as u16,
            btn_actions_ptr as *const xcb_xkb_action_t,
            leds_ptr as *const xcb_xkb_device_led_info_t,
        );
        base::VoidCookie {
            cookie: cookie,
            conn: c,
...
pub fn set_device_info_checked<'a>(
    c: &'a base::Connection,
    device_spec: DeviceSpec,
    first_btn: u8,
    change: u16,
    ...
    unsafe {
        ...
        let leds_len = leds.len();
        let leds_ptr = leds.as_ptr();
        let cookie = xcb_xkb_set_device_info_checked(
            c.get_raw_conn(),
            device_spec as xcb_xkb_device_spec_t,
            first_btn as u8,
            btn_actions_len as u8,
...
pub fn set_debugging_flags<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_xkb_set_debugging_flags(
            c.get_raw_conn(),
            message_len as u16,
            affect_flags as u32,
            flags as u32,
            affect_ctrls as u32,
            ctrls as u32,
            message_ptr as *const xcb_xkb_string8_t,
        );
...
pub fn set_debugging_flags_unchecked<'a>(
    c: &'a base::Connection,
    affect_flags: u32,
    flags: u32,
    affect_ctrls: u32,
    ...
    unsafe {
        let message_len = message.len();
        let message_ptr = message.as_ptr();
        let cookie = xcb_xkb_set_debugging_flags_unchecked(
            c.get_raw_conn(),
            message_len as u16,
            affect_flags as u32,
            flags as u32,
