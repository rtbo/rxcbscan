...
impl Range8 {
    #[allow(unused_unsafe)]
    pub fn new(first: u8, last: u8) -> Range8 {
        unsafe {
            Range8 {
    ...
    pub fn first(&self) -> u8 {
        unsafe { self.base.first }
    }
    pub fn last(&self) -> u8 {
        unsafe { self.base.last }
    }
}
...
impl Range16 {
    #[allow(unused_unsafe)]
    pub fn new(first: u16, last: u16) -> Range16 {
        unsafe {
            Range16 {
...
impl ExtRange {
    #[allow(unused_unsafe)]
    pub fn new(major: Range8, minor: Range16) -> ExtRange {
        unsafe {
            ExtRange {
    ...
    pub fn major(&self) -> Range8 {
        unsafe { std::mem::transmute(self.base.major) }
    }
    pub fn minor(&self) -> Range16 {
        unsafe { std::mem::transmute(self.base.minor) }
    }
}
...
impl Range {
    ...
    pub fn core_requests(&self) -> Range8 {
        unsafe { std::mem::transmute(self.base.core_requests) }
    }
    pub fn core_replies(&self) -> Range8 {
        unsafe { std::mem::transmute(self.base.core_replies) }
    }
    pub fn ext_requests(&self) -> ExtRange {
        unsafe { std::mem::transmute(self.base.ext_requests) }
    }
    pub fn ext_replies(&self) -> ExtRange {
        unsafe { std::mem::transmute(self.base.ext_replies) }
    }
    pub fn delivered_events(&self) -> Range8 {
        unsafe { std::mem::transmute(self.base.delivered_events) }
    }
    pub fn device_events(&self) -> Range8 {
        unsafe { std::mem::transmute(self.base.device_events) }
    }
    pub fn errors(&self) -> Range8 {
        unsafe { std::mem::transmute(self.base.errors) }
    }
    pub fn client_started(&self) -> bool {
        unsafe { self.base.client_started != 0 }
    }
    pub fn client_died(&self) -> bool {
        unsafe { self.base.client_died != 0 }
    }
}
...
impl<'a> ClientInfo<'a> {
    pub fn client_resource(&self) -> ClientSpec {
        unsafe { (*self.ptr).client_resource }
    }
    pub fn num_ranges(&self) -> u32 {
        unsafe { (*self.ptr).num_ranges }
    }
    pub fn ranges(&self) -> RangeIterator {
        unsafe { xcb_record_client_info_ranges_iterator(self.ptr) }
    }
}
...
impl<'a> QueryVersionCookie<'a> {
    pub fn get_reply(self) -> Result<QueryVersionReply, base::ReplyError> {
        ...
        let reply = unsafe {
            QueryVersionReply {
                ptr: xcb_record_query_version_reply(self.conn.get_raw_conn(), self.cookie, err_ptr),
            }
        };
...
pub fn query_version<'a>(
    ...
    unsafe {
        let cookie =
            xcb_record_query_version(c.get_raw_conn(), major_version as u16, minor_version as u16);
        QueryVersionCookie {
            cookie: cookie,
            conn: c,
            checked: true,
...
pub fn query_version_unchecked<'a>(
    ...
    unsafe {
        let cookie = xcb_record_query_version_unchecked(
            c.get_raw_conn(),
...
pub fn create_context<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_record_create_context(
            c.get_raw_conn(),
            context as xcb_record_context_t,
            element_header as xcb_record_element_header_t,
            client_specs_len as u32,
            ranges_len as u32,
            client_specs_ptr as *const xcb_record_client_spec_t,
            ranges_ptr as *const xcb_record_range_t,
        );
        base::VoidCookie {
            cookie: cookie,
            conn: c,
...
pub fn create_context_checked<'a>(
    ...
    unsafe {
        ...
        let ranges_len = ranges.len();
        let ranges_ptr = ranges.as_ptr();
        let cookie = xcb_record_create_context_checked(
            c.get_raw_conn(),
            context as xcb_record_context_t,
            element_header as xcb_record_element_header_t,
            client_specs_len as u32,
...
pub fn register_clients<'a>(
    ...
    unsafe {
        ...
        let ranges_len = ranges.len();
        let ranges_ptr = ranges.as_ptr();
        let cookie = xcb_record_register_clients(
            c.get_raw_conn(),
            context as xcb_record_context_t,
            element_header as xcb_record_element_header_t,
            client_specs_len as u32,
...
pub fn register_clients_checked<'a>(
    c: &'a base::Connection,
    context: Context,
    element_header: ElementHeader,
    client_specs: &[ClientSpec],
    ...
    unsafe {
        ...
        let ranges_len = ranges.len();
        let ranges_ptr = ranges.as_ptr();
        let cookie = xcb_record_register_clients_checked(
            c.get_raw_conn(),
            context as xcb_record_context_t,
            element_header as xcb_record_element_header_t,
            client_specs_len as u32,
...
pub fn unregister_clients<'a>(
    ...
    unsafe {
        let client_specs_len = client_specs.len();
        let client_specs_ptr = client_specs.as_ptr();
        let cookie = xcb_record_unregister_clients(
            c.get_raw_conn(),
            context as xcb_record_context_t,
            client_specs_len as u32,
            client_specs_ptr as *const xcb_record_client_spec_t,
...
pub fn unregister_clients_checked<'a>(
    c: &'a base::Connection,
    context: Context,
    client_specs: &[ClientSpec],
) -> base::VoidCookie<'a> {
    unsafe {
        let client_specs_len = client_specs.len();
        let client_specs_ptr = client_specs.as_ptr();
        let cookie = xcb_record_unregister_clients_checked(
            c.get_raw_conn(),
            context as xcb_record_context_t,
            client_specs_len as u32,
            client_specs_ptr as *const xcb_record_client_spec_t,
...
impl<'a> GetContextCookie<'a> {
    pub fn get_reply(self) -> Result<GetContextReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {
            &mut err
        } else {
        ...
        let reply = unsafe {
            GetContextReply {
                ptr: xcb_record_get_context_reply(self.conn.get_raw_conn(), self.cookie, err_ptr),
            }
        };
        let checked = self.checked;
        std::mem::forget(self);
...
impl GetContextReply {
    ...
    pub fn element_header(&self) -> ElementHeader {
        unsafe { (*self.ptr).element_header }
    }
    pub fn num_intercepted_clients(&self) -> u32 {
        unsafe { (*self.ptr).num_intercepted_clients }
    }
    pub fn intercepted_clients(&self) -> ClientInfoIterator {
        unsafe { xcb_record_get_context_intercepted_clients_iterator(self.ptr) }
    }
}

pub fn get_context<'a>(c: &'a base::Connection, context: Context) -> GetContextCookie<'a> {
    unsafe {
        let cookie = xcb_record_get_context(c.get_raw_conn(), context as xcb_record_context_t);
        GetContextCookie {
            cookie: cookie,
            conn: c,
            checked: true,
...
pub fn get_context_unchecked<'a>(
    c: &'a base::Connection,
    context: Context,
) -> GetContextCookie<'a> {
    unsafe {
        let cookie =
            xcb_record_get_context_unchecked(c.get_raw_conn(), context as xcb_record_context_t);
        GetContextCookie {
            cookie: cookie,
            conn: c,
            checked: false,
...
impl<'a> EnableContextCookie<'a> {
    pub fn get_reply(self) -> Result<EnableContextReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {
            &mut err
        } else {
        ...
        let reply = unsafe {
            EnableContextReply {
                ptr: xcb_record_enable_context_reply(
...
impl EnableContextReply {
    pub fn category(&self) -> u8 {
        unsafe { (*self.ptr).category }
    }
    pub fn element_header(&self) -> ElementHeader {
        unsafe { (*self.ptr).element_header }
    }
    pub fn client_swapped(&self) -> bool {
        unsafe { (*self.ptr).client_swapped != 0 }
    }
    pub fn xid_base(&self) -> u32 {
        unsafe { (*self.ptr).xid_base }
    }
    pub fn server_time(&self) -> u32 {
        unsafe { (*self.ptr).server_time }
    }
    pub fn rec_sequence_num(&self) -> u32 {
        unsafe { (*self.ptr).rec_sequence_num }
    }
    pub fn data(&self) -> &[u8] {
        unsafe {
            let field = self.ptr;
...
pub fn enable_context<'a>(c: &'a base::Connection, context: Context) -> EnableContextCookie<'a> {
    unsafe {
        let cookie = xcb_record_enable_context(c.get_raw_conn(), context as xcb_record_context_t);
        EnableContextCookie {
            cookie: cookie,
            conn: c,
            checked: true,
...
pub fn enable_context_unchecked<'a>(
    c: &'a base::Connection,
    context: Context,
) -> EnableContextCookie<'a> {
    unsafe {
        let cookie =
            xcb_record_enable_context_unchecked(c.get_raw_conn(), context as xcb_record_context_t);
        EnableContextCookie {
            cookie: cookie,
            conn: c,
            checked: false,
...
pub fn disable_context<'a>(c: &'a base::Connection, context: Context) -> base::VoidCookie<'a> {
    unsafe {
        let cookie = xcb_record_disable_context(c.get_raw_conn(), context as xcb_record_context_t);
        base::VoidCookie {
            cookie: cookie,
            conn: c,
            checked: false,
...
pub fn disable_context_checked<'a>(
    c: &'a base::Connection,
    context: Context,
) -> base::VoidCookie<'a> {
    unsafe {
        let cookie =
            xcb_record_disable_context_checked(c.get_raw_conn(), context as xcb_record_context_t);
        base::VoidCookie {
            cookie: cookie,
            conn: c,
            checked: true,
...
pub fn free_context<'a>(c: &'a base::Connection, context: Context) -> base::VoidCookie<'a> {
    unsafe {
        let cookie = xcb_record_free_context(c.get_raw_conn(), context as xcb_record_context_t);
        base::VoidCookie {
            cookie: cookie,
            conn: c,
            checked: false,
...
pub fn free_context_checked<'a>(c: &'a base::Connection, context: Context) -> base::VoidCookie<'a> {
    unsafe {
        let cookie =
            xcb_record_free_context_checked(c.get_raw_conn(), context as xcb_record_context_t);
        base::VoidCookie {
            cookie: cookie,
            conn: c,
            checked: true,
