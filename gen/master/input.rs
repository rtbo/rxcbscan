...
impl<'a> GetExtensionVersionCookie<'a> {
    pub fn get_reply(self) -> Result<GetExtensionVersionReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            GetExtensionVersionReply {
                ptr: xcb_input_get_extension_version_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
...
impl<'a> ListInputDevicesCookie<'a> {
    pub fn get_reply(self) -> Result<ListInputDevicesReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            ListInputDevicesReply {
                ptr: xcb_input_list_input_devices_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> OpenDeviceCookie<'a> {
    pub fn get_reply(self) -> Result<OpenDeviceReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            OpenDeviceReply {
                ptr: xcb_input_open_device_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> SetDeviceModeCookie<'a> {
    pub fn get_reply(self) -> Result<SetDeviceModeReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            SetDeviceModeReply {
                ptr: xcb_input_set_device_mode_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetSelectedExtensionEventsCookie<'a> {
    pub fn get_reply(self) -> Result<GetSelectedExtensionEventsReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            GetSelectedExtensionEventsReply {
                ptr: xcb_input_get_selected_extension_events_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetDeviceDontPropagateListCookie<'a> {
    pub fn get_reply(self) -> Result<GetDeviceDontPropagateListReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            GetDeviceDontPropagateListReply {
                ptr: xcb_input_get_device_dont_propagate_list_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetDeviceMotionEventsCookie<'a> {
    pub fn get_reply(self) -> Result<GetDeviceMotionEventsReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            GetDeviceMotionEventsReply {
                ptr: xcb_input_get_device_motion_events_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> ChangeKeyboardDeviceCookie<'a> {
    pub fn get_reply(self) -> Result<ChangeKeyboardDeviceReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            ChangeKeyboardDeviceReply {
                ptr: xcb_input_change_keyboard_device_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> ChangePointerDeviceCookie<'a> {
    pub fn get_reply(self) -> Result<ChangePointerDeviceReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            ChangePointerDeviceReply {
                ptr: xcb_input_change_pointer_device_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GrabDeviceCookie<'a> {
    pub fn get_reply(self) -> Result<GrabDeviceReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            GrabDeviceReply {
                ptr: xcb_input_grab_device_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetDeviceFocusCookie<'a> {
    pub fn get_reply(self) -> Result<GetDeviceFocusReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            GetDeviceFocusReply {
                ptr: xcb_input_get_device_focus_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetFeedbackControlCookie<'a> {
    pub fn get_reply(self) -> Result<GetFeedbackControlReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            GetFeedbackControlReply {
                ptr: xcb_input_get_feedback_control_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetDeviceKeyMappingCookie<'a> {
    pub fn get_reply(self) -> Result<GetDeviceKeyMappingReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            GetDeviceKeyMappingReply {
                ptr: xcb_input_get_device_key_mapping_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetDeviceModifierMappingCookie<'a> {
    pub fn get_reply(self) -> Result<GetDeviceModifierMappingReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            GetDeviceModifierMappingReply {
                ptr: xcb_input_get_device_modifier_mapping_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> SetDeviceModifierMappingCookie<'a> {
    pub fn get_reply(self) -> Result<SetDeviceModifierMappingReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            SetDeviceModifierMappingReply {
                ptr: xcb_input_set_device_modifier_mapping_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetDeviceButtonMappingCookie<'a> {
    pub fn get_reply(self) -> Result<GetDeviceButtonMappingReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            GetDeviceButtonMappingReply {
                ptr: xcb_input_get_device_button_mapping_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> SetDeviceButtonMappingCookie<'a> {
    pub fn get_reply(self) -> Result<SetDeviceButtonMappingReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            SetDeviceButtonMappingReply {
                ptr: xcb_input_set_device_button_mapping_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> QueryDeviceStateCookie<'a> {
    pub fn get_reply(self) -> Result<QueryDeviceStateReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            QueryDeviceStateReply {
                ptr: xcb_input_query_device_state_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> SetDeviceValuatorsCookie<'a> {
    pub fn get_reply(self) -> Result<SetDeviceValuatorsReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            SetDeviceValuatorsReply {
                ptr: xcb_input_set_device_valuators_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetDeviceControlCookie<'a> {
    pub fn get_reply(self) -> Result<GetDeviceControlReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            GetDeviceControlReply {
                ptr: xcb_input_get_device_control_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> ChangeDeviceControlCookie<'a> {
    pub fn get_reply(self) -> Result<ChangeDeviceControlReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            ChangeDeviceControlReply {
                ptr: xcb_input_change_device_control_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> ListDevicePropertiesCookie<'a> {
    pub fn get_reply(self) -> Result<ListDevicePropertiesReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            ListDevicePropertiesReply {
                ptr: xcb_input_list_device_properties_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetDevicePropertyCookie<'a> {
    pub fn get_reply(self) -> Result<GetDevicePropertyReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            GetDevicePropertyReply {
                ptr: xcb_input_get_device_property_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> XiQueryPointerCookie<'a> {
    pub fn get_reply(self) -> Result<XiQueryPointerReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            XiQueryPointerReply {
                ptr: xcb_input_xi_query_pointer_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> XiGetClientPointerCookie<'a> {
    pub fn get_reply(self) -> Result<XiGetClientPointerReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            XiGetClientPointerReply {
                ptr: xcb_input_xi_get_client_pointer_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> XiQueryVersionCookie<'a> {
    pub fn get_reply(self) -> Result<XiQueryVersionReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            XiQueryVersionReply {
                ptr: xcb_input_xi_query_version_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> XiQueryDeviceCookie<'a> {
    pub fn get_reply(self) -> Result<XiQueryDeviceReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            XiQueryDeviceReply {
                ptr: xcb_input_xi_query_device_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> XiGetFocusCookie<'a> {
    pub fn get_reply(self) -> Result<XiGetFocusReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            XiGetFocusReply {
                ptr: xcb_input_xi_get_focus_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> XiGrabDeviceCookie<'a> {
    pub fn get_reply(self) -> Result<XiGrabDeviceReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            XiGrabDeviceReply {
                ptr: xcb_input_xi_grab_device_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> XiPassiveGrabDeviceCookie<'a> {
    pub fn get_reply(self) -> Result<XiPassiveGrabDeviceReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            XiPassiveGrabDeviceReply {
                ptr: xcb_input_xi_passive_grab_device_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> XiListPropertiesCookie<'a> {
    pub fn get_reply(self) -> Result<XiListPropertiesReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            XiListPropertiesReply {
                ptr: xcb_input_xi_list_properties_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> XiGetPropertyCookie<'a> {
    pub fn get_reply(self) -> Result<XiGetPropertyReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            XiGetPropertyReply {
                ptr: xcb_input_xi_get_property_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> XiGetSelectedEventsCookie<'a> {
    pub fn get_reply(self) -> Result<XiGetSelectedEventsReply, base::ReplyError> {
        let mut err: *mut xcb_generic_error_t = std::ptr::null_mut();
        let err_ptr = if self.checked {&mut err} else {std::ptr::null_mut()};
        let reply = unsafe {
            XiGetSelectedEventsReply {
                ptr: xcb_input_xi_get_selected_events_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
