...
pub fn query_version_unchecked<'a>(
    ...
    unsafe {
        let cookie = xcb_present_query_version_unchecked(
            c.get_raw_conn(),
...
pub fn pixmap<'a>(
    ...
    unsafe {
        ...
        let cookie = xcb_present_pixmap(
            ...
            remainder as u64,
            notifies_len as u32,
            notifies_ptr as *const xcb_present_notify_t,
        );
        base::VoidCookie {
            cookie: cookie,
            conn: c,
...
pub fn pixmap_checked<'a>(
    ...
    unsafe {
        let notifies_len = notifies.len();
        let notifies_ptr = notifies.as_ptr();
        let cookie = xcb_present_pixmap_checked(
            c.get_raw_conn(),
            window as xcb_window_t,
            pixmap as xcb_pixmap_t,
            serial as u32,
...
pub fn notify_msc<'a>(
    ...
    unsafe {
        let cookie = xcb_present_notify_msc(
            c.get_raw_conn(),
            window as xcb_window_t,
            serial as u32,
            target_msc as u64,
...
pub fn notify_msc_checked<'a>(
    ...
    unsafe {
        let cookie = xcb_present_notify_msc_checked(
            c.get_raw_conn(),
            window as xcb_window_t,
            serial as u32,
            target_msc as u64,
...
pub fn select_input<'a>(
    ...
    unsafe {
        let cookie = xcb_present_select_input(
            c.get_raw_conn(),
...
pub fn select_input_checked<'a>(
    ...
    unsafe {
        let cookie = xcb_present_select_input_checked(
            c.get_raw_conn(),
            eid as xcb_present_event_t,
            window as xcb_window_t,
            event_mask as u32,
...
pub fn query_capabilities_unchecked<'a>(
    c: &'a base::Connection,
    target: u32,
...
impl ConfigureNotifyEvent {
    ...
    pub fn off_x(&self) -> i16 {
        unsafe { (*self.ptr).off_x }
    }
    pub fn off_y(&self) -> i16 {
        unsafe { (*self.ptr).off_y }
    }
    pub fn pixmap_width(&self) -> u16 {
        unsafe { (*self.ptr).pixmap_width }
    }
    pub fn pixmap_height(&self) -> u16 {
        unsafe { (*self.ptr).pixmap_height }
    }
    pub fn pixmap_flags(&self) -> u32 {
        unsafe { (*self.ptr).pixmap_flags }
    }
...
impl IdleNotifyEvent {
    ...
    pub fn pixmap(&self) -> xproto::Pixmap {
        unsafe { (*self.ptr).pixmap }
    }
    pub fn idle_fence(&self) -> sync::Fence {
        unsafe { (*self.ptr).idle_fence }
    }
...
impl RedirectNotifyEvent {
    pub fn update_window(&self) -> bool {
        unsafe { (*self.ptr).update_window != 0 }
    }
    pub fn event(&self) -> Event {
        unsafe { (*self.ptr).event }
    }
    pub fn event_window(&self) -> xproto::Window {
        unsafe { (*self.ptr).event_window }
    }
    pub fn window(&self) -> xproto::Window {
        unsafe { (*self.ptr).window }
    }
    ...
    pub fn valid_region(&self) -> xfixes::Region {
        unsafe { (*self.ptr).valid_region }
    }
    pub fn update_region(&self) -> xfixes::Region {
        unsafe { (*self.ptr).update_region }
    }
    pub fn valid_rect(&self) -> xproto::Rectangle {
        unsafe { std::mem::transmute((*self.ptr).valid_rect) }
    }
    pub fn update_rect(&self) -> xproto::Rectangle {
        unsafe { std::mem::transmute((*self.ptr).update_rect) }
    }
    pub fn x_off(&self) -> i16 {
        unsafe { (*self.ptr).x_off }
    }
    pub fn y_off(&self) -> i16 {
        unsafe { (*self.ptr).y_off }
    }
    pub fn target_crtc(&self) -> randr::Crtc {
        unsafe { (*self.ptr).target_crtc }
    }
    pub fn wait_fence(&self) -> sync::Fence {
        unsafe { (*self.ptr).wait_fence }
    }
    pub fn idle_fence(&self) -> sync::Fence {
        unsafe { (*self.ptr).idle_fence }
    }
    pub fn options(&self) -> u32 {
        unsafe { (*self.ptr).options }
    }
    pub fn target_msc(&self) -> u64 {
        unsafe { (*self.ptr).target_msc }
    }
    pub fn divisor(&self) -> u64 {
        unsafe { (*self.ptr).divisor }
    }
    pub fn remainder(&self) -> u64 {
        unsafe { (*self.ptr).remainder }
    }
    pub fn notifies_len(&self) -> u32 {
        unsafe { (*self.ptr).notifies_len }
    }
    pub fn notifies(&self) -> NotifyIterator {
        unsafe { xcb_present_redirect_notify_notifies_iterator(self.ptr) }
    }
