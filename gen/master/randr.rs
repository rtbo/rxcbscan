    ...
    pub fn get_reply(self) -> Result<SetScreenConfigReply, base::ReplyError> {
        ...
        let reply = unsafe {
            SetScreenConfigReply {
                ptr: xcb_randr_set_screen_config_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetScreenInfoCookie<'a> {
    pub fn get_reply(self) -> Result<GetScreenInfoReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetScreenInfoReply {
                ptr: xcb_randr_get_screen_info_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetScreenSizeRangeReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetScreenSizeRangeReply {
                ptr: xcb_randr_get_screen_size_range_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetScreenResourcesReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetScreenResourcesReply {
                ptr: xcb_randr_get_screen_resources_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetOutputInfoCookie<'a> {
    pub fn get_reply(self) -> Result<GetOutputInfoReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetOutputInfoReply {
                ptr: xcb_randr_get_output_info_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<ListOutputPropertiesReply, base::ReplyError> {
        ...
        let reply = unsafe {
            ListOutputPropertiesReply {
                ptr: xcb_randr_list_output_properties_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<QueryOutputPropertyReply, base::ReplyError> {
        ...
        let reply = unsafe {
            QueryOutputPropertyReply {
                ptr: xcb_randr_query_output_property_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetOutputPropertyReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetOutputPropertyReply {
                ptr: xcb_randr_get_output_property_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> SetCrtcConfigCookie<'a> {
    pub fn get_reply(self) -> Result<SetCrtcConfigReply, base::ReplyError> {
        ...
        let reply = unsafe {
            SetCrtcConfigReply {
                ptr: xcb_randr_set_crtc_config_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetCrtcGammaSizeReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetCrtcGammaSizeReply {
                ptr: xcb_randr_get_crtc_gamma_size_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetScreenResourcesCurrentReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetScreenResourcesCurrentReply {
                ptr: xcb_randr_get_screen_resources_current_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetCrtcTransformReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetCrtcTransformReply {
                ptr: xcb_randr_get_crtc_transform_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetOutputPrimaryReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetOutputPrimaryReply {
                ptr: xcb_randr_get_output_primary_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetProviderInfoReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetProviderInfoReply {
                ptr: xcb_randr_get_provider_info_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<ListProviderPropertiesReply, base::ReplyError> {
        ...
        let reply = unsafe {
            ListProviderPropertiesReply {
                ptr: xcb_randr_list_provider_properties_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<QueryProviderPropertyReply, base::ReplyError> {
        ...
        let reply = unsafe {
            QueryProviderPropertyReply {
                ptr: xcb_randr_query_provider_property_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetProviderPropertyReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetProviderPropertyReply {
                ptr: xcb_randr_get_provider_property_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
