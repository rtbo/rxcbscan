...
impl<'a> QueryVersionCookie<'a> {
    pub fn get_reply(self) -> Result<QueryVersionReply, base::ReplyError> {
        ...
        let reply = unsafe {
            QueryVersionReply {
                ptr: xcb_xf86dri_query_version_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
    ...
    pub fn get_reply(self) -> Result<QueryDirectRenderingCapableReply, base::ReplyError> {
        ...
        let reply = unsafe {
            QueryDirectRenderingCapableReply {
                ptr: xcb_xf86dri_query_direct_rendering_capable_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> OpenConnectionCookie<'a> {
    pub fn get_reply(self) -> Result<OpenConnectionReply, base::ReplyError> {
        ...
        let reply = unsafe {
            OpenConnectionReply {
                ptr: xcb_xf86dri_open_connection_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetClientDriverNameReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetClientDriverNameReply {
                ptr: xcb_xf86dri_get_client_driver_name_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> CreateContextCookie<'a> {
    pub fn get_reply(self) -> Result<CreateContextReply, base::ReplyError> {
        ...
        let reply = unsafe {
            CreateContextReply {
                ptr: xcb_xf86dri_create_context_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> CreateDrawableCookie<'a> {
    pub fn get_reply(self) -> Result<CreateDrawableReply, base::ReplyError> {
        ...
        let reply = unsafe {
            CreateDrawableReply {
                ptr: xcb_xf86dri_create_drawable_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetDrawableInfoReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetDrawableInfoReply {
                ptr: xcb_xf86dri_get_drawable_info_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetDeviceInfoCookie<'a> {
    pub fn get_reply(self) -> Result<GetDeviceInfoReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetDeviceInfoReply {
                ptr: xcb_xf86dri_get_device_info_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> AuthConnectionCookie<'a> {
    pub fn get_reply(self) -> Result<AuthConnectionReply, base::ReplyError> {
        ...
        let reply = unsafe {
            AuthConnectionReply {
                ptr: xcb_xf86dri_auth_connection_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
