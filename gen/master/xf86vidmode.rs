...
impl<'a> QueryVersionCookie<'a> {
    pub fn get_reply(self) -> Result<QueryVersionReply, base::ReplyError> {
        ...
        let reply = unsafe {
            QueryVersionReply {
                ptr: xcb_xf86vidmode_query_version_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
...
impl<'a> GetModeLineCookie<'a> {
    pub fn get_reply(self) -> Result<GetModeLineReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetModeLineReply {
                ptr: xcb_xf86vidmode_get_mode_line_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetMonitorCookie<'a> {
    pub fn get_reply(self) -> Result<GetMonitorReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetMonitorReply {
                ptr: xcb_xf86vidmode_get_monitor_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetAllModeLinesReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetAllModeLinesReply {
                ptr: xcb_xf86vidmode_get_all_mode_lines_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<ValidateModeLineReply, base::ReplyError> {
        ...
        let reply = unsafe {
            ValidateModeLineReply {
                ptr: xcb_xf86vidmode_validate_mode_line_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetViewPortCookie<'a> {
    pub fn get_reply(self) -> Result<GetViewPortReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetViewPortReply {
                ptr: xcb_xf86vidmode_get_view_port_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetDotClocksCookie<'a> {
    pub fn get_reply(self) -> Result<GetDotClocksReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetDotClocksReply {
                ptr: xcb_xf86vidmode_get_dot_clocks_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetGammaCookie<'a> {
    pub fn get_reply(self) -> Result<GetGammaReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetGammaReply {
                ptr: xcb_xf86vidmode_get_gamma_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetGammaRampCookie<'a> {
    pub fn get_reply(self) -> Result<GetGammaRampReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetGammaRampReply {
                ptr: xcb_xf86vidmode_get_gamma_ramp_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
    ...
    pub fn get_reply(self) -> Result<GetGammaRampSizeReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetGammaRampSizeReply {
                ptr: xcb_xf86vidmode_get_gamma_ramp_size_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetPermissionsCookie<'a> {
    pub fn get_reply(self) -> Result<GetPermissionsReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetPermissionsReply {
                ptr: xcb_xf86vidmode_get_permissions_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
