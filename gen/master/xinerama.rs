...
impl<'a> QueryVersionCookie<'a> {
    pub fn get_reply(self) -> Result<QueryVersionReply, base::ReplyError> {
        ...
        let reply = unsafe {
            QueryVersionReply {
                ptr: xcb_xinerama_query_version_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
...
impl<'a> GetScreenCountCookie<'a> {
    pub fn get_reply(self) -> Result<GetScreenCountReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetScreenCountReply {
                ptr: xcb_xinerama_get_screen_count_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> GetScreenSizeCookie<'a> {
    pub fn get_reply(self) -> Result<GetScreenSizeReply, base::ReplyError> {
        ...
        let reply = unsafe {
            GetScreenSizeReply {
                ptr: xcb_xinerama_get_screen_size_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
...
impl<'a> QueryScreensCookie<'a> {
    pub fn get_reply(self) -> Result<QueryScreensReply, base::ReplyError> {
        ...
        let reply = unsafe {
            QueryScreensReply {
                ptr: xcb_xinerama_query_screens_reply (self.conn.get_raw_conn(), self.cookie, err_ptr)
            }
        };
        let checked = self.checked;
        std::mem::forget(self); // won't call discard on cookie
